...
function SupportHome({ onCreateTicket }) {
    return (
                ...
                <div className="col-md-4">
                    ...
                    <div className="card mb-3 border-0 shadow-sm">
                        <div className="card-body text-center">
                            <p className="mb-2 fw-medium">Can't find what you're looking for?</p>
                            <button className="btn btn-primary w-100" onClick={onCreateTicket}>
                                <i className="fa-solid fa-ticket"></i> Create a ticket
                            </button>
                        </div>
                    </div>
